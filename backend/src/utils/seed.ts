import { PrismaClient, Difficulty, ChallengeType, OperatingSystem } from '@prisma/client';
...
async function main() {
  ...
  const challenges = [
    ...
    },
    {
      ...
      category: 'Windows',
      type: 'MACHINE' as ChallengeType,
      os: 'WINDOWS' as OperatingSystem,
      difficulty: 'HARD' as Difficulty,
      points: 250,
